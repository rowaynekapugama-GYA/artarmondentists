...
//
// SET THIS as an Environment Variable in Vercel, then redeploy:
...
//                     (use a domain verified in SMTP2GO)
...
// SmileOx intake address for this landing page (safe default; override via env if it ever changes)
